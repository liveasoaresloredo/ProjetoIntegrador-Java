...
public class LerEscreverExcel {
    ...
    private final String[] as1 = new String[5];
    private final String[] as2 = new String[5];
    private final String[] as3 = new String[5];
    private final String[] as4 = new String[5];
    private final String[] as5 = new String[5];
    private String enderecoExcel = "C:\\Users\\Aluno INRB\\IdeaProjects\\ProjetoIntegrador_JAVA";
